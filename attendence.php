      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="persons.php">Attendence Master</a></li>
            <li><a href="organizations.php">Shift</a></li>
            <li><a href="locations.php">Holiday List</a></li>
            <li><a href="news.php">Devices</a></li>
            <li><a href="delegates.php">Device Logs</a></li>
            <li><a href="topics.php">Manual Punch Entry</a></li>
            <li><a href="products.php">Process Attendence</a></li>
            <li><a href="products.php">Pending Attendence</a></li>
            <li><a href="mypriorities.php">Attendence Details</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Attendence</h2>
        </div>
      </div>
    </div>
  </body>
