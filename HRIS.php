      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="HRIS.php">HRIS</a></li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="persons.php">Employee Master</a></li>
            <li><a href="organizations.php">Document Submission</a></li>
            <li><a href="locations.php">Document Pending</a></li>
            <li><a href="news.php">Letter Management</a></li>
            <li><a href="delegates.php">Employee Registration</a></li>
            <li><a href="topics.php">Resignation Clearance</a></li>
            <li><a href="products.php">Import Employee</a></li>
            <li><a href="mypriorities.php">Import Salary</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">HRIS</h2>
        </div>
      </div>
    </div>
  </body>
