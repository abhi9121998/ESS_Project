      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="persons.php">Payroll Master</a></li>
            <li><a href="organizations.php">Salary Process</a></li>
            <li><a href="locations.php">Pay Slip</a></li>
            <li><a href="news.php">Salary Sheet</a></li>
            <li><a href="delegates.php">Monthly Net Salary</a></li>
            <li><a href="topics.php">Bank Transfer</a></li>
            <li><a href="products.php">Monthly Attendence</a></li>
            <li><a href="mypriorities.php">Monthly Arrear</a></li>
            <li><a href="products.php">Monthly Lumpsum</a></li>
          </ul>
        </div>
