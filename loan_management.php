      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="persons.php">Loan Master</a></li>
            <li><a href="organizations.php">Loan Application</a></li>
            <li><a href="organizations.php">Loan Disbursement</a></li>
            <li><a href="organizations.php">Loan Rejection</a></li>
            <li><a href="organizations.php">Loan Balance Ledger</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Loan Management</h2>
        </div>
      </div>
    </div>
  </body>
