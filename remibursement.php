      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="persons.php">Remibursement Policy</a></li>
            <li><a href="organizations.php">Remibursement Request</a></li>
            <li><a href="locations.php">Remibursement-Disbursement</a></li>
            <li><a href="news.php">Remibursement Rejection</a></li>
            <li><a href="delegates.php">Bank Advice/Transfer</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Remibursement</h2>
        </div>
      </div>
    </div>
  </body>
