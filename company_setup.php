      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="company_setup.php">Company Setup</a></li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="persons.php">Company Master</a></li>
            <li><a href="organizations.php">Rate Editor</a></li>
            <li><a href="locations.php">Bank</a></li>
            <li><a href="news.php">Document Master</a></li>
            <li><a href="delegates.php">SMTP Details</a></li>
            <li><a href="topics.php">Mailing Template</a></li>
            <li><a href="products.php">Location</a></li>
            <li><a href="mypriorities.php">Export-Import Mapping</a></li>
            <li><a href="products.php">Leave Settings</a></li>
            <li><a href="products.php">User Rights</a></li>
            <li><a href="products.php">Reminder & Alerts</a></li>
            <li><a href="products.php">Reporting Managers</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="page-header">Company Setup</h2>
        </div>
      </div>
    </div>
  </body>
